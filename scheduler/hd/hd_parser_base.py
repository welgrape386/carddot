...
# 설정
# ─────────────────────────────────────────────
_BASE_DIR    = os.path.dirname(os.path.abspath(__file__))   # scheduler/hd/

CARDS_JSON   = os.path.join(_BASE_DIR, "hd_ouput", "최종본", "hd_cards.json")
HTML_OUT_DIR = os.path.join(_BASE_DIR, "hd_html")
