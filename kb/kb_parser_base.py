...
# 경로 설정 (__file__ 기준)
# ─────────────────────────────────────────────
_HERE    = os.path.dirname(os.path.abspath(__file__))   # kb/parser/
_KB_DIR  = os.path.dirname(_HERE)                       # kb/

CARDS_JSON   = os.path.join(_KB_DIR, "claud", "최종본", "kb_cards.json")
HTML_OUT_DIR = os.path.join(_KB_DIR, "html")
OUTPUT_DIR   = os.path.join(_KB_DIR, "claud")
